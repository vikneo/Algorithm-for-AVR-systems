# Generated by Django 5.0.1 on 2024-01-25 02:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subjects', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='children', to='firmwares.client', verbose_name='Объект')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ManyToManyField(to='firmwares.client', verbose_name='Объект')),
                ('relay', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='firmwares.smartrelay', verbose_name='Тип ПЛК')),
            ],
            options={
